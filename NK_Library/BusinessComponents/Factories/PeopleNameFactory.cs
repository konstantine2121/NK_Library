...
{
    /// <summary>
    /// Создает случайные русские имена.
    /// </summary>
    internal class PeopleNamesFactory : RandomContainer, ICreator<string>
    {
        #region Surnames
...
"Яшин"
        ...
        private readonly char[] _firstCharactersOfNames =
            {
            'А',
            'Б',
            'В',
        ...
        {
            return _surnames[Rand.Next(_surnames.Length)];
        }

        private string GetRandomInitial()
        {
            return _firstCharactersOfNames[Rand.Next(_firstCharactersOfNames.Length)].ToString();
        }
    }
}
